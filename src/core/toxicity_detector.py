...
_TOXICITY_PROMPT = """\
Ты проверяешь сообщения покупателей на токсичность для магазина техники Apple.

КОНТЕКСТ: покупатели часто пишут короткими фразами — технические характеристики,
цвета, типы SIM, объёмы памяти. Это НОРМАЛЬНЫЕ сообщения магазина, НЕ спам:
«сим+есим», «nano sim», «silver», «256гб черный», «esim», «1 sim + esim»,
«нано+есим», «lte», «wifi», «да», «нет», «сколько стоит», «есть в наличии?»

Считай токсичным ТОЛЬКО если сообщение содержит:
...
- Спам (ссылки на сторонние сайты, рекламные рассылки)

НЕ считай токсичным:
- Любые короткие ответы («да», «нет», «ок», «понял», «спасибо»)
- Технические характеристики устройств (SIM-тип, цвет, память, модель)
