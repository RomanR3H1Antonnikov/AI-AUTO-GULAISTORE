...
_ESCALATION_RE = re.compile(
    ...
    r"|минуту,?\s+(?:сейчас\s+)?уточн[а-я]+"  # «минуту, уточню» ИЛИ «минуту, сейчас уточню»
    r"|сейчас\s+уточн[а-я]+"                   # standalone «сейчас уточню»
    r"|уточн[а-я]+\s+наличие"                  # «уточню наличие» — при неизвестной позиции
    r"|передал[аи]?\s+ваш"                     # «передала ваш номер/запрос»
    r"|менеджер\s+свяжется"                    # «менеджер свяжется с вами»
    r")",
    re.IGNORECASE,
)
