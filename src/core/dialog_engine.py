...
Активированный (актив): новый, запечатанный, но один раз включался и прошёл активацию.
  → Полностью рабочий, гарантия та же. Функционально идентичен неактивированному.

Цена одинаковая для обоих вариантов.
